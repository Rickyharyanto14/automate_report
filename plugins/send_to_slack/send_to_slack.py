...
def execute(message, channel, file_bytes, file=None, file_type=None, title=None, encoding='ascii'):
...
if __name__ == '__main__':
    execute('test', '#course', 'C:\\Users\\ASUS\\.vscode\\automate_report\\output\\sales_per_month.png', file=None, file_type=None, title=None, encoding='ascii')